 ...
 * methods are sufficient, and will not issue block updates. Finally, it will never call the vanilla redstoneBundleProvider
...
public interface IConnectableRedNet
{
	 ...
	 * whereas "Single" types will onInputChanged() to be called for input changes and the normal redstoneBundleProvider power output methods
